...
# Kenneth Roe
#
# Creates auroc cureve for gradient_boosting_tree classifier
...
svc_grid_11 = pickle.load(open(dir_11+'gradient_boosting_tree.pickle', "rb" ))
...
svc_grid_42 = pickle.load(open(dir_42+'gradient_boosting_tree.pickle', "rb" ))
...
svc_grid_32 = pickle.load(open(dir_32+'gradient_boosting_tree.pickle', "rb" ))
...
svc_grid_16 = pickle.load(open(dir_16+'gradient_boosting_tree.pickle', "rb" ))
...
svc_grid_8 = pickle.load(open(dir_8+'gradient_boosting_tree.pickle', "rb" ))
...
svc_grid_4 = pickle.load(open(dir_4+'gradient_boosting_tree.pickle', "rb" ))
...
svc_grid_2 = pickle.load(open(dir_2+'gradient_boosting_tree.pickle', "rb" ))
...
s1 = str('Gradient boosting (Labs, 11 filtered features, AUC %0.3f)' % roc_auc)
s2 = str('Gradient boosting (Labs, 42 features, AUC %0.3f)' % roc_auc1)
s3 = str('Gradient boosting (Labs, 32 features, AUC %0.3f)' % roc_auc2)
s4 = str('Gradient boosting (Labs, 16 features, AUC %0.3f)' % roc_auc3)
s5 = str('Gradient boosting (Labs, 8 features, AUC %0.3f)' % roc_auc4)
s6 = str('Gradient boosting (Labs, 4 features, AUC %0.3f)' % roc_auc5)
s7 = str('Gradient boosting (Labs, 2 features, AUC %0.3f)' % roc_auc6)

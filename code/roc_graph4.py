...
svc_grid_11d = pickle.load(open(dir_11d+'gradient_boosting_tree.pickle', "rb" ))
...
svc_grid_11i = pickle.load(open(dir_11i+'gradient_boosting_tree.pickle', "rb" ))
...
svc_grid_11t = pickle.load(open(dir_11t+'gradient_boosting_tree.pickle', "rb" ))
...
#svc_grid_42d = pickle.load(open(dir_42d+'gradient_boosting_tree.pickle', "rb" ))
...
svc_grid_42i = pickle.load(open(dir_42i+'gradient_boosting_tree.pickle', "rb" ))
...
plt.legend((s1,s2,s3,s4,s5,s7), loc=2, borderaxespad=0., bbox_to_anchor=(1.05, 1))
